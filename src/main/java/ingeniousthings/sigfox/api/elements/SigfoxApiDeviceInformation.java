 ...
 * Summary
 *
 * Object retruned by sigfox API corresponding to a Device.
 *
 * ----------------------------------------------------------------------------------
 * Response Format :
 *  {
...
public class SigfoxApiDeviceInformation {
    ...
    public ingeniousthings.sigfox.api.elements.SigfoxApiDeviceInformation.DeviceLocation getComputedLocation() {
        return computedLocation;
    }

    public void setComputedLocation(ingeniousthings.sigfox.api.elements.SigfoxApiDeviceInformation.DeviceLocation computedLocation) {

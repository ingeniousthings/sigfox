...
public class SigfoxApiMessageInformationList {
    ...
    public ingeniousthings.sigfox.api.elements.SigfoxApiMessageInformationList.MessageListPaging getPaging() {
        return paging;
    }

    public void setPaging(ingeniousthings.sigfox.api.elements.SigfoxApiMessageInformationList.MessageListPaging paging) {
        this.paging = paging;
    }

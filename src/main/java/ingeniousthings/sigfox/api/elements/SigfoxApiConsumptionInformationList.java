...
public class SigfoxApiConsumptionInformationList {
    ...
    static class Consumption {
        ...
        public ingeniousthings.sigfox.api.elements.SigfoxApiConsumptionInformationList.Consumptions[] getConsumptions() {
            return consumptions;
        }

        public void setConsumptions(ingeniousthings.sigfox.api.elements.SigfoxApiConsumptionInformationList.Consumptions[] consumptions) {
    ...
    public ingeniousthings.sigfox.api.elements.SigfoxApiConsumptionInformationList.Consumption getConsumption() {
        return consumption;
    }

    public void setConsumption(ingeniousthings.sigfox.api.elements.SigfoxApiConsumptionInformationList.Consumption consumption) {
